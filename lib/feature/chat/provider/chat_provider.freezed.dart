...
class _$ChatInputStateImpl implements _ChatInputState {
  const _$ChatInputStateImpl({this.message = '', this.isLoading = false});
  ...
  @override
  String toString() {
    return 'ChatInputState(message: $message, isLoading: $isLoading)';
  }
...
abstract class _ChatInputState implements ChatInputState {
  const factory _ChatInputState({final String message, final bool isLoading}) =
